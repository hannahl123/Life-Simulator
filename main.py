  ...
  if choice1 == "1":
    ...
    if choice2 == "1":
      ...
      if choice3 == "1":
        ...
        print("...")
        sleep(1)
        print("Another 3 years have passed. You like one of your female colleagues and they like you, too. You choose to: ")
        sleep(6)
        print("1. Marry her")
        sleep(0.5)
        print("2. Don't marry (you will not have another option to marry in the rest of your life)")
        sleep(2)
        choice6marriage = input("Choose [1/2]: ")
        # Male Choice
        if choice6marriage == "1":
          sleep(0.5)
